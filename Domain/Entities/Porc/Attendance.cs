...
namespace Domain.Entities.Porc
{
    public class Attendance
    {
        ...
        public int RoundedSalary { get; set; }

        public int FeedRightPay { get; set; }

        public int FoodStuffRightPay { get; set; }

        public int LeaveBalance { get; set; }

        public int TotalLoanInstallments { get; set; }
