...
{
    public abstract class BaseEntityMap<TEntityType> : IEntityTypeConfiguration<TEntityType> where TEntityType : BaseEntity
    {
        protected BaseEntityMap(string schema = null, string tableName = null, bool usePrefixTableName = true)
        {
            SchemaName = schema;
